...
func cowsHeadInCow() (*asset, error) {
	...
	info := bindataFileInfo{name: "cows/head-in.cow", size: 257, mode: os.FileMode(420), modTime: time.Unix(1479175215, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
